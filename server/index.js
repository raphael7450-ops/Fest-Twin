...
export function securityHeadersMiddleware(_request, response, next) {
  ...
  response.setHeader(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://oapi.map.naver.com https://openapi.map.naver.com https://ncp-docs.map.naver.com https://*.map.naver.com https://*.naver.com https://*.naver.net https://*.pstatic.net https://map.pstatic.net https://nrbe.pstatic.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.pstatic.net https://map.pstatic.net https://nrbe.pstatic.net; img-src 'self' data: blob: https: https://*.map.naver.com https://*.naver.com https://*.naver.net https://*.pstatic.net https://map.pstatic.net https://nrbe.pstatic.net; font-src 'self' https://fonts.gstatic.com https://*.pstatic.net https://map.pstatic.net https://nrbe.pstatic.net; connect-src 'self' https://apis.data.go.kr https://viewt.ktdb.go.kr https://oapi.map.naver.com https://openapi.map.naver.com https://*.map.naver.com https://*.naver.com https://*.naver.net https://*.pstatic.net https://map.pstatic.net https://nrbe.pstatic.net https://kr-col-ext.nelo.navercorp.com;",
  );
  next();
}
