...
export function securityHeadersMiddleware(_request, response, next) {
  ...
  response.setHeader(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://oapi.map.naver.com https://openapi.map.naver.com https://ncp-docs.map.naver.com https://*.map.naver.com https://*.naver.com https://*.naver.net https://*.pstatic.net https://map.pstatic.net https://nrbe.pstatic.net https://map.vworld.kr https://*.vworld.kr; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.pstatic.net https://map.pstatic.net https://nrbe.pstatic.net https://map.vworld.kr https://*.vworld.kr; img-src 'self' data: blob: https: https://*.map.naver.com https://*.naver.com https://*.naver.net https://*.pstatic.net https://map.pstatic.net https://nrbe.pstatic.net https://map.vworld.kr https://*.vworld.kr; font-src 'self' https://fonts.gstatic.com https://*.pstatic.net https://map.pstatic.net https://nrbe.pstatic.net https://map.vworld.kr https://*.vworld.kr; connect-src 'self' https://apis.data.go.kr https://viewt.ktdb.go.kr https://oapi.map.naver.com https://openapi.map.naver.com https://*.map.naver.com https://*.naver.com https://*.naver.net https://*.pstatic.net https://map.pstatic.net https://nrbe.pstatic.net https://kr-col-ext.nelo.navercorp.com https://map.vworld.kr https://*.vworld.kr;",
  );
  next();
}
